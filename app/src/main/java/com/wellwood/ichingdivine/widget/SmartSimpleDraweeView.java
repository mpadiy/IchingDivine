package com.wellwood.ichingdivine.widget;
...
import com.wellwood.ichingdivine.util.BaseApplication;
import com.wellwood.ichingdivine.util.NetworkUtil;
        ...
        if (!PrefUtils.isSaveNetMode()) {
            ...
            if (!NetworkUtil.isWifiAvailable() && NetworkUtil.isMobileNetAvailable()) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    placeImage = getResources().getDrawable(R.drawable.click_load_image, BaseApplication.getContext().getTheme());
                } else {
