...
public class GDContentsActivity extends BaseListActivity<String> {
    ...
    private void initGDContents(){
        if (mDataList == null) {
            mDataList = new ArrayList<String>();
        }
        mDataList.add("作者序");   //pos = 0
        mDataList.add("译者序");   //pos = 1
        mDataList.add("01 乾为天");  //pos = 2
    ...
    class SampleViewHolder extends BaseViewHolder {
        ...
        public void onItemClick(View view, int position) {
            String gdContentLink = getString(getApplicationContext().getResources().getIdentifier("gdHtml" + position , "string",getApplicationContext().getPackageName()));
            ...
            Toast.makeText(GDContentsActivity.this, "tiaozhuan...",
