...
public class ExpandableTextView1 extends LinearLayout implements View.OnClickListener {
    ...
    public void setOrientation(int orientation){
        if(LinearLayout.HORIZONTAL == orientation){
            throw new IllegalArgumentException("ExpandableTextView1 only supports Vertical Orientation.");
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Doesn't fit in collapsed mode. Collapse text customizedview as needed. Show
        // button.
        if (mCollapsed) {
